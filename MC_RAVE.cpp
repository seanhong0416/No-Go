...
Node * MC_RAVE::selection(Node * parent){
...
int MC_RAVE::random_simulation(Node * start, board::piece_type who_start){
...
void MC_RAVE::update_value(std::vector<Node *>& route, int v){
